...
class EmailClassifier:
    def __init__(self):
        ...
        if not api_key:
            logger.warning("OPENAI_API_KEY not found in environment variables. LLM layer will fail.")
    ...
    def _call_llm(self, sender: str, subject: str, snippet: str) -> Optional[ClassificationResult]:
        ...
        try:
            ...
            response = self.client.chat.completions.create(
                ...
                messages=[
                    {"role": "system", "content": "You are a helpful assistant that classifies emails accurately and strictly follows JSON output formats."},
